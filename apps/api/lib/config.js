...
export function loadConfig() {
  ...
  return Object.freeze({
    ...
    playback: Object.freeze({
      syncIntervalMs: intEnv('PLAYBACK_SYNC_INTERVAL_MS', 1500, { min: 1000, max: 60000 }),
      softDriftMs: intEnv('PLAYBACK_SOFT_DRIFT_MS', 100, { min: 50, max: 2000 }),
      hardDriftMs: intEnv('PLAYBACK_HARD_DRIFT_MS', 500, { min: 250, max: 10000 })
    }),
